...
class ControllerModuleTestimonial extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_catalog_testimonial->editSeoUrl($this->request->post['testimonial_seo_url']);	
		...
		if (isset($this->request->post['testimonial_seo_url'])) {
			$this->data['testimonial_seo_url'] = $this->request->post['testimonial_seo_url'];
		} else {
			$this->data['testimonial_seo_url'] = $this->model_catalog_testimonial->getSeoUrl();
		}
