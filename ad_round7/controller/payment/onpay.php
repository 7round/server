...
class ControllerPaymentOnPay extends Controller {
	...
	public function index() {
		...
		$this->data['entry_onpay_create_order_status_id'] = $this->language->get('entry_onpay_create_order_status_id');
		...
		if (isset($this->request->post['onpay_create_order_status_id'])) {
			$this->data['onpay_create_order_status_id'] = $this->request->post['onpay_create_order_status_id'];
		} else {
			$this->data['onpay_create_order_status_id'] = $this->config->get('onpay_create_order_status_id');
		}
		...
		foreach(array('price_final', 'ticker', 'ln', 'f') as $param) {
			if(isset($this->request->post['onpay_params'][$param])) {
				$this->data['onpay_params'][$param] = $this->request->post['onpay_params'][$param];
			} else {
				$params = $this->config->get('onpay_params');
				$this->data['onpay_params'][$param] = isset($params[$param])?$params[$param]:null;
			}
		}

		if (isset($this->request->post['onpay_param'])) {
			$this->data['onpay_param'] = $this->request->post['onpay_param'];
		} else {
			$this->data['onpay_param'] = $this->config->get('onpay_param');
		}
