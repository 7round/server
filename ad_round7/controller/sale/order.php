...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
		...
		$this->data['tab_total'] = $this->language->get('tab_total');
 		...
 		if (isset($this->error['payment_fathername'])) {
			$this->data['error_payment_fathername'] = $this->error['payment_fathername'];
		} else {
			$this->data['error_payment_fathername'] = '';
		}                
		...
		if (isset($this->error['payment_method'])) {
 		...
 		if (isset($this->error['shipping_fathername'])) {
			$this->data['error_shipping_fathername'] = $this->error['shipping_fathername'];
		} else {
			$this->data['error_shipping_fathername'] = '';
		}
    	...
    	if (isset($this->request->post['fathername'])) {
			...
			$this->data['fathername'] = $order_info['fathername'];
		} else {
    	...
    	if (isset($this->request->post['payment_fathername'])) {
      		$this->data['payment_fathername'] = $this->request->post['payment_fathername'];
		} elseif (!empty($order_info)) { 
			$this->data['payment_fathername'] = $order_info['payment_fathername'];
		} else {
      		$this->data['payment_fathername'] = '';
    	}
    	...
    	if (isset($this->request->post['shipping_fathername'])) {
      		$this->data['shipping_fathername'] = $this->request->post['shipping_fathername'];
		} elseif (!empty($order_info)) { 
			$this->data['shipping_fathername'] = $order_info['shipping_fathername'];
		} else {
      		$this->data['shipping_fathername'] = '';
    	}
  	...
  	private function validateForm() {
    	...
    	if ((utf8_strlen($this->request->post['payment_fathername']) < 1) || (utf8_strlen($this->request->post['payment_fathername']) > 32)) {
      		$this->error['payment_fathername'] = $this->language->get('error_fathername');
    	}
		...
		if ($shipping) {
			...
			if ((utf8_strlen($this->request->post['shipping_fathername']) < 1) || (utf8_strlen($this->request->post['shipping_fathername']) > 32)) {
				$this->error['shipping_fathername'] = $this->language->get('error_fathername');
			}
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $this->data['text_fathername'] = $this->language->get('text_fathername');
			...
			foreach ($products as $product) {
				...
				$price = explode(' ', $this->data['products'][$k]['price']);
				$this->data['products'][$k]['total'] = ($price[0]*$product['quantity'])." ".$price[1];
			}
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$replace = array(
                    ...
                    'firstname' => $order_info['payment_fathername'],
				...
				foreach ($products as $product) {
					...
					$k = count($product_data)-1;
			
					$price = explode(' ', $product_data[$k]['price']);
					$product_data[$k]['total'] = ($price[0]*$product['quantity'])." ".$price[1];
