...
$_['text_sbrf_online']    = '<a onclick="window.open(\'https://online.sberbank.ru\');"><img src="view/image/payment/sbrf_online.png" alt="Сбербанк-Онлайн" title="Сбербанк-Онлайн"/></a>';
$_['text_copyright']      = 'Payment module "%s" is developed by ShopUtils. Questions about the technical support of the module send via the website <a href="http://opencart.shoputils.ru/?route=information/contact" target="_blank">http://opencart.shoputils.ru</a>.<br />License: Free<br />Donations: R292933412576; U248193076365; Z285667459181; E264386531109; Yandex.Money 4100161452035<br />&copy; ShopUtils 2010 &mdash; %s';
...
// Placehoder
$_['help_bank']           = 'Variebles:<br /><br />{order_id} - Order ID<br /><br />{total} - Total<br /><br />{shipping_total} - Shipping Total';
...
$_['help_description']    = 'Additional description on the checkout page. To display it requires editing a file checkout \ payment_method.tpl your template (see. 2 of README.TXT in the root distribution). If you are using the module "<a href="https://opencartforum.com/files/file/324-" target="_blank">Simple - simplified registration and order</a>" - additional amendments do not require.';
