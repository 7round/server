...
$_['text_copyright']      = 'Модуль оплаты "%s" разработан ShopUtils. Вопросы по техподдержке и работе модуля отправляйте через сайт <a href="http://opencart.shoputils.ru/?route=information/contact" target="_blank">http://opencart.shoputils.ru</a>.<br />Лицензия: Free<br />Реквизиты для спасибо: R292933412576; U248193076365; Z285667459181; E264386531109; Yandex.Money 4100161452035<br />&copy; ShopUtils 2010 &mdash; %s';
...
// Placehoder
$_['help_bank']           = 'Поддерживаемые переменные:<br /><br />{order_id} - Номер заказа<br /><br />{total} - Сумма всего заказа к оплате<br /><br />{shipping_total} - Стоимость доставки к оплате';
...
$_['help_description']    = 'Дополнительное описание на странице оформления заказа. Для его отображения требуется правка файла checkout\payment_method.tpl Вашего шаблона (см. п.2 README.TXT в корне дистрибутива). Если используется модуль "<a href="https://opencartforum.com/files/file/324-" target="_blank">Simple - упрощенная регистрация и заказ</a>" - дополнительных правок делать не требуется.';
