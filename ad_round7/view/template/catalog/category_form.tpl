          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="category_description[<?php echo $language['language_id']; ?>][title]" cols="40" rows="5"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['title'] : ''; ?></textarea></td>
              </tr>
              <tr>
