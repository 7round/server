          ...
          <table id="special" class="list">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo $entry_date_start; ?></td>
                <td class="left"><?php echo $entry_date_end; ?></td>
                <td class="left"><?php echo $entry_special_sort_order; ?></td>
                <td></td>
              </tr>
            </thead>
            <?php $special_row = 0; ?>
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><input type="text" name="product_special[<?php echo $special_row; ?>][special_sort_order]" value="<?php echo $product_special['special_sort_order']; ?>" size="2" /></td>
