    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><input name="payment_schet_inn" type="text" size="20" value="<?php echo $payment_schet_inn; ?>" /> 
            <?php echo $entry_kpp; ?> <input name="payment_schet_kpp" type="text" size="20" value="<?php echo $payment_schet_kpp; ?>" />
            <?php if ($error_inn) { ?>
