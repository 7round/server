  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="language<?php echo $language['language_id']; ?>">
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $entry_kpp; ?></td>
          <td><input name="sberbank_transfer_kpp_<?php echo $language['language_id']; ?>" type="text" size="20" value="<?php echo isset(${'sberbank_transfer_kpp_' . $language['language_id']}) ? ${'sberbank_transfer_kpp_' . $language['language_id']} : ''; ?>" /><br />
            <?php if (isset(${'error_kpp_' . $language['language_id']})) { ?>
            <span class="error"><?php echo ${'error_kpp_' . $language['language_id']}; ?></span>
            <?php } ?></td>
        </tr>
        <tr>
