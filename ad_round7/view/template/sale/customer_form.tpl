        ...
        <div id="tab-general">
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                <td><span class="required">*</span> <?php echo $entry_fathername; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][fathername]" value="<?php echo $address['fathername']; ?>" />
                  <?php if (isset($error_address_fathername[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_fathername[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
...
function addAddress() {	
    ...
    html += '    </tr>';
	html += '    <tr>';
    html += '	   <td><span class="required">*</span> <?php echo $entry_fathername; ?></td>';
    html += '	   <td><input type="text" name="address[' + address_row + '][fathername]" value="" /></td>';
    html += '    </tr>';
    html += '    <tr>';
