      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-customer" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="fathername" value="<?php echo $fathername; ?>" />
        ...
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_fathername; ?></td>
              <td><input type="text" name="payment_fathername" value="<?php if ($payment_fathername=='') echo $fathername; else echo $payment_fathername; ?>" />
                <?php if ($error_payment_fathername) { ?>
                <span class="error"><?php echo $error_payment_fathername; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_fathername; ?></td>
              <td><input type="text" name="shipping_fathername" value="<?php if ($shipping_fathername=='') echo $fathername; else echo $shipping_fathername; ?>" />
                <?php if ($error_shipping_fathername) { ?>
                <span class="error"><?php echo $error_shipping_fathername; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
...
$('input[name=\'customer\']').catcomplete({
	...
	select: function(event, ui) { 
        ...
        $('input[name=\'fathername\']').attr('value', ui.item['fathername']);
		...
		for (i in  ui.item['address']) {
			html += '<option value="' + ui.item['address'][i]['address_id'] + '">' + ui.item['address'][i]['firstname'] + ui.item['address'][i]['fathername'] + ' ' + ui.item['address'][i]['lastname'] + ', ' + ui.item['address'][i]['address_1'] + ', ' + ui.item['address'][i]['city'] + ', ' + ui.item['address'][i]['country'] + '</option>';
		}
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
                ...
                $('input[name=\'payment_fathername\']').attr('value', json['fathername']);
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
                ...
                $('input[name=\'shipping_fathername\']').attr('value', json['fathername']);
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['fathername']) {
					$('input[name=\'fathername\']').after('<span class="error">' + json['error']['fathername'] + '</span>');
				}
				...
				if (json['error']['payment']) {	
					...
					if (json['error']['payment']['fathername']) {
						$('input[name=\'payment_fathername\']').after('<span class="error">' + json['error']['payment']['fathername'] + '</span>');
					}
				...
				if (json['error']['shipping']) {		
					...
					if (json['error']['shipping']['fathername']) {
						$('input[name=\'shipping_fathername\']').after('<span class="error">' + json['error']['shipping']['fathername'] + '</span>');
					}
