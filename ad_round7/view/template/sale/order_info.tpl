    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $customer; ?>"><?php echo $firstname; ?> <?php echo $fathername; ?> <?php echo $lastname; ?></a></td>
          </tr>
          <?php } else { ?>
          <tr>
            <td><?php echo $text_customer; ?></td>
            <td><?php echo $firstname; ?> <?php echo $fathername; ?> <?php echo $lastname; ?></td>
          </tr>
          <?php } ?>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_fathername; ?></td>
            <td><?php if ($payment_fathername=='') echo $fathername; else echo $payment_fathername; ?></td>
          </tr>
          <tr>
      ...
      <div id="tab-shipping" class="vtabs-content">
        <table class="form">
          <tr>
           ...
           <tr>
            <td><?php echo $text_fathername; ?></td>
            <td><?php if ($shipping_fathername=='') echo $fathername; else echo $shipping_fathername; ?></td>
          </tr>
          <tr>
            <td><?php echo $text_lastname; ?></td>
