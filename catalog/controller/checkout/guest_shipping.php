...
class ControllerCheckoutGuestShipping extends Controller {
  	public function index() {	
		...
		if (isset($this->session->data['guest']['shipping']['fathername'])) {
			$this->data['fathername'] = $this->session->data['guest']['shipping']['fathername'];
		} else {
	...
	public function validate() {
		...
		if (!$json) {
            ...
            $this->session->data['guest']['shipping']['fathername'] = trim($this->request->post['fathername']);
