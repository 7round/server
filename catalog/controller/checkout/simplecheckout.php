...
class ControllerCheckoutSimpleCheckout extends Controller { 
        ...
        if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            if ($this->config->get('simple_common_view_agreement_id')) {
                ...
                if ($this->data['information_info']) {
                    ...
                    $this->data['text_agree'] = sprintf($this->language->get($id), 'index.php?route=information/information/info&information_id=' . $this->config->get('simple_common_view_agreement_id'), $this->data['information_info']['title'], $this->data['information_info']['title']);
    ...
    private function order() {
		...
		$total_data[2]['text'] = $_SESSION['total']." руб.";
