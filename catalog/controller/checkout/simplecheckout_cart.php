...
// echo "<pre>"; var_dump($total_data); die;             
            $sort_order = array(); 
        ...
        if(count($total_data) < 3){
            ...
            $total_data[1]['text'] = $item_3 = $_SESSION['product_total']." руб.";
        ...
        if ($current_theme == 'shoppica' || $current_theme == 'shoppica2') {
            ...
            $this->data['cart_total'] = sprintf($this->language->get('text_items'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0), $item_3." руб.");
        }
