...
// var_dump($this->document->addScript('catalog/view/javascript/filterpro.min.js')); die;				
...
// var_dump($this->document->getScripts()); die;
...
// var_dump($max_price); die;
		...
		$min_price = $this->currency->format($this->tax->calculate($min_price, $product_info['tax_class_id'], $this->config->get('config_tax')));
		$max_price = $this->currency->format($this->tax->calculate($max_price, $product_info['tax_class_id'], $this->config->get('config_tax')));
// var_dump($max_price); die;
