 ...
 public function index()
  ...
  foreach ($this->session->data['compare'] as $key => $product_id)
   ...
   if ($product_info)
    ...
    $availability = $this->language->get($product_info["stock_status"]);
    ...
    $this->data['products'][$product_id] = array(
        ...
        'stock_status_id' => array_key_exists("stock_status_id",$product_info)?$product_info['stock_status_id']:null,
