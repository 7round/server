...
// var_dump($product_info['price']); die;  
      $c_id=$this->currency->getCode();

      if ($c_id=='EUR'){
          $p=$this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')),"RUB");
      }else{
          $p=$this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')),"EUR");
      }
        
      $this->data['price'].="<small>(".$p.")</small>";
...
// var_dump($this->data['price']); die;   
   if ((float) $product_info['special'])
    ...
    $c_id=$this->currency->getCode();
      if ($c_id=='EUR')
      {
          $p=$this->currency->format($this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax')),"RUB");
      }
      else
          $p=$this->currency->format($this->tax->calculate($product_info['special'], $product_info['tax_class_id'], $this->config->get('config_tax')),"EUR");
      $this->data['special'].="<small>(".$p.')</small>';
