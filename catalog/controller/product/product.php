    ...
    public function index()
    {
        ...
        if ($product_info) {
            ...
            if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
                ...
                $p = explode(" ", $this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')), $c_id));
                $this->data['price'] .= "<small>(" . $p[0] . ".00 " . $p[1] . ")</small>";
            } else {
