$(document).ready(function() {
	...
	var showimg = "image/allcattext.png";
	var hideimg = "image/allcattext2.png";
	...
	$(window).load(function(){
	 ...
	 $('#linktext').click(function () {
	    $('#img_1').toggle(function() {
	      $('.hide_description').css('display','block');
	      $('#img_1').attr('src',hideimg);
	    }, function() {
	      $('.hide_description').css('display','none');
	      $('#img_1').attr('src',showimg);
	    });
	  });

	 $('#linktext2').click(function () {
	    $('#img_2').toggle(function() {
	      $('#show_hide2').css('display','block');
	      $('#img_2').attr('src',hideimg);
	    }, function() {
	      $('#show_hide2').css('display','none');
	      $('#img_2').attr('src',showimg);
	    });
	  });
