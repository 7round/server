...
<?php } ?>
    ...
    <?php foreach ($products as $product) { ?>
        ...
        <tr>
            ...
            <td class="total" style='line-height: normal;'><nobr style='font-size:22px;'><?php echo $product['total']; ?></nobr></td>
            <td class="remove">
            ...
            <?php foreach ($vouchers as $voucher_info) { ?>
                <tr>
                    ...
                    <td class="total" style='line-height: normal;'><nobr style='font-size:22px;'><?php echo $voucher_info['amount']; ?></nobr></td>
                    <td class="remove">
