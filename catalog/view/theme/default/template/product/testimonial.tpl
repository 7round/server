...
<div id="content">
  ...
  <div class="middle testimonial_block">
    ...
    <?php if (true/*$testimonials*/) { ?>
      ...
      <tr>
         <td valign="top" style="font-size: 20px; text-align:left;" colspan="2"><b><?php echo $testimonial['title']; ?></b></td>
      </tr>
      <tr>
      	<td colspan="2" style="text-align:left;" class="testimonial_description">
