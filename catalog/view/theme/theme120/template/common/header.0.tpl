  ...
  <div class="main-shining">
    <div class="row-1">
      <div id="header">
        ...
        <div id="yangiKontakt"><img src="kontakt_tel.png" alt="tel" height="26"> &nbsp;+7 951 784-48-22&nbsp;(Россия)&nbsp;&nbsp;<img src="skype.gif" alt="skype" width="26" height="26"> &nbsp;round7cz&nbsp;(Skype)</div>

		<div class="site-feedback">
		  <ul>
		    <li class="callback"><a id="call-link" onclick="$('#contactable').fadeIn();" >Заказать звонок</a></li>
		  </ul>
		</div>
