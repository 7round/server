      ...
      <div id="search">
        ...
        <?php if ($filter_name) { ?>
          <span class="search-bg">
            <input type="text" name="filter_name" value="" placeholder="Что желаете найти?"  />
          </span>
        <?php } else { ?>
          <span class="search-bg">
            <input type="text" name="filter_name" value="" onClick="this.value = '';" placeholder="Что желаете найти?" />
          </span>
        <?php } ?>
      <!--/ noindex -->
      </div>
...
<!-- Contactable -->
<link rel="stylesheet" property="stylesheet" type="text/css" href="catalog/view/theme/theme120/stylesheet/contactable.css" />
