  ...
  <div class="product-info">
    ...
    <div class="extra-wrap">
      ...
      <div class="description">
        ...
        <?php } ?>
        <div class="padd-avalib"> <div class="extra-wrap"> <span class="prod-stock-2"><?php echo $text_stock; ?></span> <div class="prod-stock prod-stock_<?php echo $product_info["stock_status_id"]; ?>"><?php /*echo $stock;*/ ?></div></div></div>
      <?php if ($price) { ?>
      <div class="price">
