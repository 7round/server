  ...
  <div class="product-info">
    ...
    <div class="extra-wrap">
      ...
      <div class="description">
        <?php if ($manufacturer) { ?>
        <span><?php echo $text_manufacturer; ?></span> <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a><div id="mlogo" style="float: right; position: relative;top: -20px; "><img src="<?php echo $mimage; ?>" title="<?php echo $manufacturer; ?>" /></div><br />
        <?php } ?>
        ...
        <div class="padd-avalib"> 
          <div class="extra-wrap"> 
            ...
            <img class="prod-stock prod-stock_<?php echo $product_info["stock_status"]; ?>" src="http://round7.ru/catalog/view/theme/theme120/image/<?php echo $stock_status; ?>">

            <img class="prod-stock-hover close" src="http://round7.ru/catalog/view/theme/theme120/image/<?php echo $stock_status_hover; ?>" >
      ...
      <?php if ($review_status) { ?>
        <div class="review">
        <!-- noindex -->
          <div><img src="catalog/view/theme/theme120/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<div class="btn-rew"><a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div></div>
		...
		<div>
			<span class="vk_widgets">
				<script type="text/javascript">
					...
					var img = '<?php echo $images[0]['thumb']; ?>';
					console.log(img);
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme120/image/loading.gif" class="loading" style="padding-left: 5px;" />');
