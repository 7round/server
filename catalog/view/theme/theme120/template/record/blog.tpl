...
<br />
  ...
  <div class="record-list">
    ...
    <div style="height: 180px;">
      ...
      <?php if ($record['thumb']) { ?>
      <div class="image"  style="float:left; margin-right: 15px;"><a href="<?php echo $record['href']; ?>"><img src="<?php echo $record['thumb']; ?>" title="<?php echo $record['name']; ?>" alt="<?php echo $record['name']; ?>" /></a></div>
      <?php } ?>
